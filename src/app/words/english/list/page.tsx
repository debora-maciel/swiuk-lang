    ...
    return (
        <div className="w-full py-2 flex flex-col">
            ...
            <div className="contents w-4/6">
                ...
                {
                    viewKnown ? (
                        <table className=" border-separate rounded-l-lg border-spacing-2 border border-black/10 dark:border-black/10">
                            <thead className="">
                                <tr className="">
                                    <th>
                                        <div className="w-full flex items-center">
                                            ...
                                            <div className="flex w-2/4 flex justify-end pr-1 text-sm">
                                                <button className="border border-black/30 text-black/60 font-normal rounded-full px-2 py-1">
                                                    + New word
                                                </button>
                                            </div>
                                        </div>
                                        <div className="border border-black/20 rounded-full flex items-center justify-start gap-2 px-2 py-2 mt-2 shadow-md mb-2">
                                            <IoIosSearch />
                                            <input
                                                value={searchKnown}
                        ...
                        :
                        (
                            <table className="w-full mx-auto border-separate rounded-lg border-spacing-2 border border-black/10 dark:border-black/10">
                                <thead className="">
                                    <tr className="">
                                        <th>
                                            Unknown
                                            <div className="border border-black/20 rounded-full flex items-center justify-start gap-2 p-2 mt-2 shadow-md mb-2">
                                                <IoIosSearch />
                                                <input
                                                    value={searchUnknown}
