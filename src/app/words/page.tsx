    ...
    return (
        <div className="min-h-screen">
            ...
            <div className={`flex flex-col justify-center items-center w-full`}>
                ...
                <Link href={'/words/deutsch'} className={`border w-3/5 ${colors.border20} rounded-xl shadow-md p-4`}>
                    <div className={`flex gap-3 font-semibold`}>
                        <div className={`${colors.text} border px-1 font-semibold rounded `}>DE</div>
                        Deutsch
                    </div>
                ...
                <Link href={'/words/english'} className={`border w-3/5 ${colors.border20} rounded-xl shadow-md p-4 mt-5`}>
                    <div className={`flex gap-3 font-semibold`}>
                        <div className={`${colors.text} border px-1 font-semibold rounded `}>EN</div>
                        English
                    </div>
                    <p className={`${colors.text60} text-sm pt-2`}>
